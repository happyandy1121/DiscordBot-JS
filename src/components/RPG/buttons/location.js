...
module.exports = {
	...
	async execute(interaction, client) {
		...
		if (customID === 'townLoc') { var ans = town() }
		else if (customID === 'farmLoc') { var ans = farm() }
		else if (customID === 'mineLoc') { var ans = mine() }
		else if (customID === 'logLoc') { var ans = log() }
		else if (customID === 'fishLoc') { var ans = fish() }
